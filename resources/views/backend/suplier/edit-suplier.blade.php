    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('supliers.update',$editData->id ) }}" id="myForm">
                        @csrf
                  ...
                  <div class="form-group col-md-8">
                    ...
                    <input type="mobile_no" name="mobile_no" class="form-control"  value="{{$editData->mobile_no}}" required>
                  </div>
                  ...
                  <div class="form-group col-md-8">
                    ...
                    <input type="address" name="address" class="form-control"  value="{{$editData->address}}" required>
                  </div>
