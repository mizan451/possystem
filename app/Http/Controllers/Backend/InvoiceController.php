...
class InvoiceController extends Controller
{
    ...
    public function store(Request $request)
    {
    	if ($request->category_id == null) {
           ...
           if ($request->paid_amount>$request->estimated_amount) {
           	   return redirect()->back()->with('error','Paid Amount is maximun than total price');
           }else{
           	$invoice = new Invoice();
    ...
    public function approvalStore(Request $request, $id){
        ...
        return redirect()->route('invoice.pending.list')->with('success', 'Invoice Successfully added');
    }
    ...
    public function dailyReportPdf(Request $request)
    {
        ...
        $data['start_date'] = date('Y-m-d', strtotime($request->end_date));
